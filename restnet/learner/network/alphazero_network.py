...
from .value_unit import TValueNetwork, ValueNetwork, BoardEvaluationNetwork
...
class AlphaZeroNetwork(nn.Module):
    ...
    def get_backbone(self, blocktype):
        if blocktype == "R":
            ...
            raise ValueError("block type is not supported")
    ...
    def get_policy_net(self, policytype):
        if policytype == "TP":
            ...
            raise ValueError("policy type is not supported")
